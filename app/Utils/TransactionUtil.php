...
{   
    ...
    public function getReceiptDetails($transaction_id, $location_id, $invoice_layout, $business_details, $location_details, $receipt_printer_type)
    {
        ...
        if(isset($transaction->commision_agent_name)){
            $commision_agent = $transaction->commision_agent_name;
        }
        ...
        $output = [
            ...
            'commision_agent' => !empty($transaction->commission_agent_data->user_full_name) ? $transaction->commission_agent_data->user_full_name : '',
        ];
