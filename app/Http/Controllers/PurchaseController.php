...
class PurchaseController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $transaction_data['staff_note'] = $request->invoice_no;
            ...
            $this->productUtil->adjustStockOverSelling($transaction);
             ...
             //Account Module
             $this->moduleUtil->getModuleData('after_purchases_saved_acc', ['transaction' => $transaction, 'input' => []]);
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $update_data['staff_note'] = $request->invoice_no;
