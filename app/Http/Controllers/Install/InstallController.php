...
class InstallController extends Controller
{
    ...
    public function postDetails(Request $request)
    {
        ...
        try {
            ...
            //pos boot
            $return = null; //pos_boot($input['APP_URL'], __DIR__, $input['ENVATO_PURCHASE_CODE'], $input['ENVATO_EMAIL'], $input['ENVATO_USERNAME']);
            if (!empty($return)) {
                return $return;
            }
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            $return = null; // pos_boot(config('app.url'), __DIR__, $input['ENVATO_PURCHASE_CODE'], $input['ENVATO_EMAIL'], $input['ENVATO_USERNAME'], 1);
            if (!empty($return)) {
                return $return;
            }
