...
class InstallController extends Controller
{
    ...
    {
        $this->module_name = 'productserial';
        $this->appVersion = config('productserial.module_version');
    }
    ...
    public function install()
    {
        ...
        Artisan::call('module:migrate', ['module' => "ProductSerial"]);
        Artisan::call('module:seed', ['module' => "ProductSerial"]);
        System::addProperty($this->module_name . '_version', $this->appVersion);

        $output = ['success' => 1,
                    'msg' => 'Product Serial module installed succesfully'
                ];
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = ['success' => 1,
                        'msg' => 'Product Serial module updated Succesfully to version ' . $this->appVersion . ' !!'
                    ];
