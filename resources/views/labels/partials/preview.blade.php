	...
	@while($details['qty'] > 0)
		...
		<div style="display:inline-block;vertical-align:middle;line-height:16px !important;">
			...
			@if(!empty($print['business_name']))
				<b style="display: block !important; font-size:12px;" class="text-uppercase">DIGITAL  @if(!empty($contact_id)) <span style="font-size:10px;"> - {{$contact_id}} </span> @endif</b> 
			...
			{{-- Product Name --}}
			@if(!empty($print['name']))
				<span style="display: block !important; font-size:9px;">
