    ...
    @foreach($purchase->purchase_lines as $purchase_line)
        <tr>
            ...
            <td>
                ...
                FOC
                {!! Form::text('purchases[' . $row_count . '][foc]', number_format($purchase_line->foc, $quantity_precision, $currency_details->decimal_separator, $currency_details->thousand_separator), ['class' => 'form-control input-sm purchase_quantity_foc input_number mousetrap', 'required', 'data-rule-abs_digit' => $check_decimal, 'data-msg-abs_digit' => __('lang_v1.decimal_value_not_allowed')]); !!}
