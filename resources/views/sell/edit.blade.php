...
<input type="hidden" id="item_addition_method" value="{{$business_details->item_addition_method}}">
	...
	<div class="row">
		<div class="col-md-12 col-sm-12">
			...
			@php
				$is_pg = !empty($transaction->selling_price_group_id) ? true : false;	
			@endphp
					...
					<table class="table table-condensed table-bordered table-striped table-responsive" id="pos_table">
						...
						<tbody>
							@foreach($sell_details as $sell_line)
								@include('sale_pos.product_row', ['product' => $sell_line, 'is_pg'=>$is_pg, 'location_id_df' => $transaction->location_id, 'row_count' => $loop->index, 'tax_dropdown' => $taxes, 'sub_units' => !empty($sell_line->unit_details) ? $sell_line->unit_details : [], 'action' => 'edit' ])
							@endforeach
						</tbody>
					</table>
					</div>
